...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Login Sistem Absensi Microservices SMP Negeri 5 Mandai</title>
...
<main class="form-signin">
  <form method="POST" id="formLogin">
    <img class="mb-4" src="css/logo.png" alt="" width="180" height="180">
    ...
    <div class="form-floating">
      <select class="form-control mt-3 mb-3" name="hak_akses" id="akses">
        <option value="1"> Admin</option>
        <option value="1"> Guru</option>
        <option value="2"> Siswa</option>
      </select>
      <label for="akses">Pilih Hak Kases</label>
    </div>
    

    <button class="w-100 btn btn-lg btn-success text-white" type="submit">Sign in</button>
