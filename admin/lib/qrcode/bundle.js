...
o.active = !1, o.webcam = null, o.canvas = null, o.ctx = null, o.decoder = null, o.setCanvas = () => {
    ...
    n(), o.setCanvas(), o.decoder = new Worker("decoder.js"), window.isMediaStreamAPISupported ? o.webcam.addEventListener("play", (function(e) {
        t || (a(), t = !0)
        ...
        a.length > 1 ? (t = {
            ...
            audio: !1
        }, window.iOS && (t.video.facingMode = "environment"), i(t)) : a.length ? (t = {
            video: {
                mandatory: {
            ...
            audio: !1
        }, window.iOS && (t.video.facingMode = "environment"), t.video.mandatory.sourceId || window.iOS ? i(t) : i({
            video: !0
        })) : i({
            video: !0
        })
...
"serviceWorker" in navigator && window.addEventListener("load", (() => {
    navigator.serviceWorker.register("/service-worker.js").then((t => {
        console.log("SW registered: ", t), localStorage.getItem("offline") || (localStorage.setItem("offline", !0), e.show("App is ready for offline usage.", 5e3))
    })).catch((e => {
    ...
    var e = null,
        ...
        n = document.querySelector(".app__dialog"),
        i = document.querySelector(".app__dialog-overlay"),
    ...
    var u = document.querySelector(".app__header-icon"),
        ...
        var audi0 = document.querySelector("#beepAudio");
    ...
    function w() {
        e = null, s.value = "", window.isMediaStreamAPISupported || (t.src = "", t.className = ""), n.classList.add("app__dialog--hide"), i.classList.add("app__dialog--hide"), y()
    }
    window.appOverlay = document.querySelector(".app__overlay"), window.addEventListener("load", (e => {
        ...
        console.log("Result: ", e), ((e = "") => new RegExp("^(https?:\\/\\/)", "i").test(e))(e) || (e = `//${e}`);
