...
<html lang="en">
  ...
  <body>
      ...
      <main class="app__layout-content">
        ...
        <form id="resultform">
            ...
            <div class="app__dialog-content">
                <input type="text" name="id_siswa" value="<?php echo $_GET['id_siswa']; ?>" style="display: none;">
                <input type="text" name="kelas" value="<?php echo $_GET['kelas']; ?>" style="display: none;">
                <input type="text" name="val" id="result" style="display: none;">
            </div>
    ...
    <img src="../css/logo.png" style="position: absolute;">
...
// var _url  = "controller_absen.php?val="+result+"";
